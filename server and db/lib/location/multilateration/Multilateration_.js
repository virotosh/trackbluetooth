...
java.classpath.push("../../jar/commons-math3-3.5.jar");
...
const SphericalMercatorProjection = require('../projection/SphericalMercatorProjection')
...
class Multilateration {
  ...
  getDistances(beacons) {
    var distances = [];
    for (var beaconIndex = 0; beaconIndex < beacons.length; beaconIndex++) {
      distances[beaconIndex] = beacons[beaconIndex].getDistance();
    }
    return distances;
  }
